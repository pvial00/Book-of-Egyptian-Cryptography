...
''' Egyptian Star Code Generator version (A) AAA '''
...
def _run():
    ...
    alphabetD, alphabet_listD = _alphabet_generator(n)
    ...
    path0 = _path_shift(alphabet_listD, msg0)
    print("path0: ", path0)
    path1 = _path_shift(alphabet_listD, msg1)
    print("path1: ", path1)
    path2 = _path_shift(alphabet_listD, msg2)
    print("path2: ", path2)
    double_msg0 = _double_func_add(alphabet_listD, msg0)
    print("double + ", double_msg0)
    double_msg1 = _double_func_sub(alphabet_listD, msg1)
    print("double - ", double_msg1)
    hebewD, hebewB, hebewA = _hebew_transformation(alphabet_listD, msg0)
    print("Hebew Delta", hebewD)
    print("Hebew Transformations", hebewB, hebewA)
    windD, windB, windA = _wind_transformation(alphabet_listD, msg0)
    print("Wind Delta", windD)
    print("Wind Transformations", windB, windA)
    radioD, radioB, radioA = _radio_transformation(alphabet_listD, msg0)
    print("Radio Delta", radioD)
    print("Radio Transformations", radioB, radioA)
    asiaD, asiaB, asiaA = _radio_transformation(alphabet_listD, msg0)
    print("Asia Delta", asiaD)
    print("Asia Transformations", asiaB, asiaA)
    auD, auB, auA = _au_transformation(alphabet_listD, msg0)
    print("AU Delta", auD)
    print("AU Transformations", auB, auA)
    auD, auB, auA = _au_transformation(alphabet_listD, msg0)
    print("AU Delta", auD)
    print("AU Transformations", auB, auA)
    betelD, betelB, betelA = _betel_transformation(alphabet_listD, msg0)
    print("Betel Delta", betelD)
    print("Betel Transformations", betelB, betelA)
    artaxD, artaxB, artaxA = _au_transformation(alphabet_listD, msg0)
    print("Artax Delta", artaxD)
    print("Artax Transformations", artaxB, artaxA)
    wajdetD, wajdetB, wajdetA = _au_transformation(alphabet_listD, msg0)
    print("Wajdet Delta", wajdetD)
    print("Wajdet Transformations", wajdetB, wajdetA)
    psyD, psyT, psyB, psyA = _psy_transformation(alphabet_listD, msg0)
    print("Psy Delta", psyD)
    print("Psy Delta T", psyT)
    print("Psy Transformations", psyB, psyA)
    betelHeqetVenusD, betelHeqetVenusT, betelHeqetVenusB, betelHeqetVenusA = _betel_heqet_venus_transformation(alphabet_listD, _keyword)
    ...
    uD, uT, uB, uA = _U_transformation(alphabet_listD, msg0)
    print("U Delta", uD)
    print("U Delta T", uT)
    print("U Transformations", uB, uA)
